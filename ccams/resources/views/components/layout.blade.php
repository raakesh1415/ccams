                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        @if (Auth::user()->role === 'student' || Auth::user()->role === 'teacher')
                            <a class="nav-link collapsed {{ request()->is('registration') || request()->is('registration/viewRegister') || request()->is('activities') ? 'active' : '' }}"
                            ...
                            <div class="collapse {{ request()->is('registration') || request()->is('registration/viewRegister') || request()->is('activities') ? 'show' : '' }}"
