        ...
        @else
            <div class="row g-3"> <!-- Add spacing between rows -->
                @foreach ($registrations as $registration)
                    <div class="col-lg-4 col-md-6 col-sm-12"> <!-- Responsive column layout -->
                        <div class="card shadow-sm h-100"> <!-- Full-height card for alignment -->
                            ...
                            <div class="card-body d-flex flex-column"> <!-- Center content -->
                                <!-- Club Name -->
                                <h4 class="card-title text-center">{{ $registration->club->club_name }}</h4>

                                <!-- Club Registered Status -->
                                <div class="text-center mt-auto"> <!-- Align to the bottom -->
